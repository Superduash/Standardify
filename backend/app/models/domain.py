...
class LLMResult:
    """
    Output generated by LLM provider inference.

    Attributes:
        text: Generated plain-language response.
        provider_used: Inference provider identifier ('groq', 'gemini', 'cache').
        latency_ms: Time taken for response generation in milliseconds.
        used_clause_ids: List of clause citation identifiers referenced by the model.
    """
